...
<Project Type="Project" LVVersion="14008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="DAQmx Watchdog configuration.lvclass" Type="LVClass" URL="../module/configuration/DAQmx Watchdog configuration.lvclass"/>
		<Item Name="DAQmx Watchdog editor node.lvclass" Type="LVClass" URL="../editor node/DAQmx Watchdog editor node.lvclass"/>
		<Item Name="DAQmx Watchdog runtime.lvclass" Type="LVClass" URL="../module/execution/DAQmx Watchdog runtime.lvclass"/>
		<Item Name="DAQmx Watchdog tests.lvlib" Type="Library" URL="../Test/DAQmx Watchdog tests.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="results to tag bus.vi" Type="VI" URL="../module/execution/results to tag bus.vi"/>
			<Item Name="parameter user data.ctl" Type="VI" URL="../module/execution/parameter user data.ctl"/>
			<Item Name="result user data.ctl" Type="VI" URL="../module/execution/result user data.ctl"/>
